...
export const orders = [
  ...
  },
  {
    ...
    customer_name: "Alex Morgan",
    items: [
      { product_id: "prod-004", variant_id: "EEP-WHT", product_name: "Elevate Earbuds Pro", quantity: 2, price_at_purchase: 159.00 },
      { product_id: "prod-006", variant_id: "SGC-BLK", product_name: "Stealth Gaming Controller", quantity: 1, price_at_purchase: 79.99 },
    ],
    shipping_address: { street: "123 Innovation Drive", city: "San Francisco", state: "CA", zip: "94105", country: "US" },
    subtotal: 397.99,
    tax: 31.84,
    ...
    created_at: "2026-01-05T18:20:00Z",
  },
];
...
export const reviews = [
  { id: "rev-001", product_id: "prod-001", user_name: "Alex M.", rating: 5, comment: "Absolutely stunning watch. The titanium feels premium and the battery lasts forever.", verified: true, created_at: "2025-12-25T10:00:00Z" },
  { id: "rev-002", product_id: "prod-001", user_name: "Jamie L.", rating: 5, comment: "Best smartwatch I've ever owned. The health tracking is incredibly accurate.", verified: true, created_at: "2025-12-28T14:00:00Z" },
  { id: "rev-003", product_id: "prod-003", user_name: "Sarah C.", rating: 4, comment: "Great sound quality. Noise cancellation could be a bit stronger, but overall fantastic.", verified: true, created_at: "2025-11-15T09:00:00Z" },
  { id: "rev-004", product_id: "prod-002", user_name: "Mike T.", rating: 5, comment: "Blazing fast performance. The display is absolutely gorgeous.", verified: false, created_at: "2025-12-01T16:00:00Z" },
];
...
export const heroSlides = [
  ...
  {
    id: 2,
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuB2dtZVC226ys07PtbTQx4YgkKNIQcWYrtiorBhs4vkb8M4XQxhWiv59oh6sNT3uN310X_p-DU1ixoX8YGMzPXdQKm7XDbXuwVNPpVknngvkAtFYbWS0RwboEb_4bhMJybhXIuY8kUMXZtOKeiZbRyder8UfzPLkDJxexZr03mXQmQDdZzuDKCDKTWa4pAHuPk77UtruIQxvzTXFVAtSBl_SnMROUJEMaRRK9i1KiDU2vYEDjB5sYQWTgG5nvrFsFkFCSUx962fWpI",
    alt: "Luxury smartwatch collection",
  ...
  {
    id: 3,
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuANCrGd9qY7HHoEeG7gYPYBTC6WKMnxGJd1lbjDT2swZgT14lG8JhV3ZvFcUv6UMiEnHLia0zFXtQ0kdADyRj6Eza0qdbweiky5T1e2PV-LppZqoOHru0A2PZ_482LkUv3ew744ciOm5u8ksqgIYom6wgpgAdtdvBR15g9CrriW07kFE_iL4TjEPguv1LOtxx_Lo3eHYkyeCWafPIy73CCtXW4sfTDfmk2q6rkpjfID0GLiMwrggxzHcpuvVDuaofYLE3TcMtZqibE",
...
export function getDiscountPercent(basePrice, discountPrice) {
