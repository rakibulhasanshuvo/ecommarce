...
export default function ProductCard({ product, variant = "default" }) {
  ...
  const defaultVariant = product.variants?.[0] || { sku: product.id, price: displayPrice, stock_quantity: product.stock_quantity || 10, options_map: {} };
  ...
  if (variant === "featured") {
    // Wide featured card (like the trending product)
    return (
